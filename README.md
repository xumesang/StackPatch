...
4. [Usage Guide](#usage-guide)
   - [Recommended: STM32F401RE](#recommended-stm32f401re)  
   - [GD32VF103](#gd32vf103)  
   - [ESP32S3](#esp32s3) 
5. [License](#license) 
...
- **Evaluation/Effectiveness/NetworkServiceLatency**  
...
**Recommended**: STM32F401RE with Keil µVision5 (version < 5.36).
...
### Recommended: STM32F401RE (NUCLEO-F401RE board)
- IDE: keil µVision5 (version < 5.36)

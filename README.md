...
└─── User : User's program.
Note that the DebugMon_Handler and HardFault_Handler in startup_stm32f401xe.s are our modified Exception handlers. The cve.c file is a vulnerability function in our paper. The patch.c file is a hot patch for C programs generated by StackPatch. 

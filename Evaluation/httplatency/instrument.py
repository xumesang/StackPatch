...
include_strs = ['#define PATCH_FUNCTION_ERR_CODE __asm("break 0,0");\n'
				]
...
add_instrument("zephyr_1141_func.txt", ins_dirs,
			   ["int", "u64_t", "u32_t", "u16_t", "u8_t", "void", "char", "bool", "size_t"], ret_cons=True,
			   remove=False)
print("\n".join(ret_types))

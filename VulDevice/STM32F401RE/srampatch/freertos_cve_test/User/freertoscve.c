...
/*cve2021-31572*/
StreamBufferHandle_t cve2021_31572( size_t xBufferSizeBytes, size_t xTriggerLevelBytes, BaseType_t xIsMessageBuffer )
{
...
void test_cve2021_31572(void){
	StreamBufferHandle_t i = cve2021_31572(0xFFFFFFFF,0,1);
	if(i == NULL){
	      printf("cve2021_31572 patch success!\r\n");
	}
}
